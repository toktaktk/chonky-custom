    ...
    renderThumbsEntry() {
        ...
        const iconProps = {
            className: classnames({
                'chonky-file-list-entry-icon': true,
                'chonky-text-subtle-light': loading,
                'chonky-icon-over-image': (file && file.thumbnailUrl),
            }),
        };

        const imageStyle = (file && file.thumbnailUrl) ? {backgroundImage: `url('${file.thumbnailUrl}')`} : {};
        const BgColors = (file && file.thumbnailUrl) ? ColorsDark : ColorsLight;
        ...
        return <div className="chonky-file-list-entry-content"
            ...
            <div className="chonky-file-list-entry-thumb">
                ...
                <div className="chonky-file-list-entry-image-bg" style={imageStyle}/>
                <div className="chonky-file-list-entry-image-fg" style={imageStyle}/>
